...
import { P as Provider, R as Root3, T as Trigger$1, a as Portal$2, C as Content2$1 } from "../_libs/radix-ui__react-tooltip.mjs";
...
import { t as timeAgo } from "./news-feed-DDav6-1E.mjs";
import { n as PanelLeft, a as Bell, o as BellOff, p as Heart, q as MessageCircle, X } from "../_libs/lucide-react.mjs";
...
function useUserNotifications(user) {
  ...
  reactExports.useEffect(() => {
    ...
    const channel = supabase.channel(`user-notify-${user.id}`).on(
      "postgres_changes",
      {
        event: "INSERT",
        schema: "public",
      ...
      (payload) => {
        ...
        if (n.type === "like") {
          ...
          toast.info(`${who} মন্তব্য করেছেন`, { description: n.body ?? void 0 });
        }
      }
    ).subscribe();
    return () => {
...
function NotifIcon({ type }) {
  if (type === "like")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "size-4 fill-rose-500 text-rose-500 shrink-0" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "size-4 text-academy-navy shrink-0" });
}
function NotifText({ n }) {
  const who = n.actor_name || "একজন";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-academy-navy/90 leading-snug", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-academy-navy", children: who }),
      n.actor_meta && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground", children: [
        " · ",
        n.actor_meta
      ] }),
      " ",
    ...
    n.type === "comment" && n.body && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: [
      "“",
      n.body,
      "”"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: timeAgo(n.created_at) })
  ] });
}
function NotificationsBell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { onOpenChange, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          unread > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 text-[10px] font-bold text-white bg-red-500 rounded-full px-1 min-w-[18px] h-[18px] flex items-center justify-center leading-none", children: unread > 9 ? "9+" : unread })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "end", className: "w-80 p-0 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b bg-academy-soft/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-academy-navy", children: "নোটিফিকেশন" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-80", children: notifs && notifs.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border/60", children: notifs.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "li",
        {
          className: `flex items-start gap-2.5 px-4 py-3 ${!n.is_read ? "bg-academy-gold/5" : ""}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(NotifIcon, { type: n.type }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(NotifText, { n })
          ]
        },
        n.id
      )) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 text-center text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BellOff, { className: "size-8 mx-auto mb-2 opacity-40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "কোনো নোটিফিকেশন নেই" })
      ] }) })
    ] })
  ] });
}
export {
  ...
  SidebarContent as d,
  SidebarGroup as e,
  SidebarGroupLabel as f,
  SidebarGroupContent as g,
  SidebarMenu as h,
  SidebarMenuItem as i,
  SidebarMenuButton as j,
  SidebarFooter as k
};
