...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BoGpn9wQ.mjs");
...
const manifest = {
  "3647d76219b1f7498636f1521523ef0bd4db1b5500147283836ce2343c38b11e": {
    functionName: "getPdfDownloadUrl_createServerFn_handler",
    importer: () => import("./site.functions-CNX_ZDKC.mjs")
  },
  "d32a89716f8dfbc9c4487e683562baeb6857d6d61810527c0762055dad688afe": {
    functionName: "getExamToppers_createServerFn_handler",
    importer: () => import("./student-stats.functions-B6aV17Tj.mjs")
  },
  "a697a2427b4e8a52059a2d2ffc69698cd8b4134ef4f9d318dff6505641716872": {
    functionName: "getMyClassPosition_createServerFn_handler",
    importer: () => import("./student-stats.functions-B6aV17Tj.mjs")
  },
  "e8e52ac00ab0a87cbe53cfcbfc78584acde27cbb6865d9060b473a61ba8e950b": {
    functionName: "getMonthlyClassMerit_createServerFn_handler",
    importer: () => import("./student-stats.functions-B6aV17Tj.mjs")
  },
  "2a6a278b97a24e8039bc58615402c494518d87223e067466daf786b5f1879cd9": {
    functionName: "setMyPhoto_createServerFn_handler",
    importer: () => import("./student-photo.functions-CadA-AiK.mjs")
  },
  "b0980aca9b03f4c97b016650970472ca5e9d89dd9e01af095432e2097510d418": {
    functionName: "getMyPhotoUrl_createServerFn_handler",
    importer: () => import("./student-photo.functions-CadA-AiK.mjs")
  },
  "0178e54aab8dc50fda474bc24bd1b377d83d5cec3f554dec88a847f9a2cbad16": {
    functionName: "getExamQuestions_createServerFn_handler",
    importer: () => import("./mcq-exam.functions-UWOZv7jG.mjs")
  },
  "4944ede2a3ee245a7b8d803a1c8c8c2ca89110942813b3e65df140405a36227b": {
    functionName: "listQuestions_createServerFn_handler",
    importer: () => import("./mcq-exam.functions-UWOZv7jG.mjs")
  },
  "a5d1683bb4b95702362a2075c4db3a5d4a6c725523ed01783551fc52c852d883": {
    functionName: "addManualQuestion_createServerFn_handler",
    importer: () => import("./mcq-exam.functions-UWOZv7jG.mjs")
  },
  "039d12a690ef404de37f7d36b2f1cc36217007db89f0ff8c8ad611137ecdee39": {
    functionName: "deleteQuestion_createServerFn_handler",
    importer: () => import("./mcq-exam.functions-UWOZv7jG.mjs")
  },
  "62b36bc49952779054a80a7137354e32b57d18e19764c680023c660b1b90aa1a": {
    functionName: "aiGenerateQuestions_createServerFn_handler",
    importer: () => import("./mcq-exam.functions-UWOZv7jG.mjs")
  },
  "67104b0ad0f902c9082fea8532deffe60afe3f694b2747ff1642b5b987de74d6": {
    functionName: "teacherSignup_createServerFn_handler",
    importer: () => import("./teacher.functions-BJRWNJmJ.mjs")
  },
  "34d6b810e18b5bd0b649092fea3e4305b0b44607518969d459923f5aafa88373": {
    functionName: "listTeachers_createServerFn_handler",
    importer: () => import("./teacher.functions-BJRWNJmJ.mjs")
  },
  "65164ee1284c263c620a557ef52b01460ff1fed4ef562485487e943d4d16779e": {
    functionName: "setTeacherPermission_createServerFn_handler",
    importer: () => import("./teacher.functions-BJRWNJmJ.mjs")
  },
  "d1281c587aa83399699ff80cfcfb8da6bde1b61ce7c8f48b15159a4273ae5960": {
    functionName: "createStudentAccount_createServerFn_handler",
    importer: () => import("./admin.functions-Cradm_hG.mjs")
  },
  "b4f744ed33855f0a21ae2c89fbab6aab79cf5301fc4e2fe686559ed0fb7df3c2": {
    functionName: "bootstrapAdminAccount_createServerFn_handler",
    importer: () => import("./admin.functions-Cradm_hG.mjs")
  },
  "06628d9cc974261677972ea34a60b163199fc08c454cc0b55cfe9f0049fc54b3": {
    functionName: "checkAdminExists_createServerFn_handler",
    importer: () => import("./admin.functions-Cradm_hG.mjs")
  },
  "27aeb153a917bb953e3f5a8b11c0ab7125188fc155f7e1d966f8c50023e304b5": {
    functionName: "sendBulkSms_createServerFn_handler",
    importer: () => import("./sms.functions-DhrPDx3M.mjs")
  },
  "6943534347f56242f50e500b18d39b90dc1377a093a548fc533aedda28d18a4c": {
    functionName: "generateCourseCover_createServerFn_handler",
    importer: () => import("./course-cover.functions-C8bWnl95.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DRo2Iz1N.mjs").then((n) => n.r),
    import("./start-GKFPd7hW.mjs"),
